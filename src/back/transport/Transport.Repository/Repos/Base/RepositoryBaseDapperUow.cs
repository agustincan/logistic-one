...
{
    internal abstract class RepositoryBaseDapperUow<T, TKey, TDbContext> : RepositoryBaseDapper<T, TKey, TDbContext>
        where TKey : struct
        ...
        where TDbContext : DbContext, new()
    {
        ...
        protected new async Task<Option<T>> GetByIdAsync(TKey id, string TableName)
        {
