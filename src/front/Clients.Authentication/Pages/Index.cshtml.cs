using Clients.Authentication.Extensions;
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPost()
        {
            using (var client = new HttpClient())
            {
                ...
                //var request =  await client.PostAsJsonAsync(_identityUrl + "v1/identity/authentication", model);
                var request = await client.PostAsJsonAsync(_identityUrl + "systemuser/authentication", model);
                ...
                var result = await request.ReadContentAs<IdentityAccess>();
